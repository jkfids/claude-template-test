...
metadata:
  upstream: https://github.com/K-Dense-AI/scientific-agent-skills/tree/330c8e764435a731eff571e3efdda70b363d0792/skills/sympy
  modified-by: Stemma
  version: "1.3"
...
Declare only assumptions justified by the problem; do not add positivity just to
...
5. **Simplification not working as expected**
   ...
   - Check which assumptions the problem actually establishes
   - Use targeted transformations; forced power/log identities can change the domain or branches
