...
metadata:
  upstream: https://github.com/K-Dense-AI/scientific-agent-skills/tree/330c8e764435a731eff571e3efdda70b363d0792/skills/scientific-visualization
  modified-by: Stemma
  version: "1.2"
...
Script paths are relative to this skill directory. For Python imports, add its
`scripts/` directory to `PYTHONPATH`; create output directories before running the CLIs.
